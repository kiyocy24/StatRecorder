...
"""
        const val CREATE_KILL_LOGS = "CREATE TABLE IF NOT EXISTS `kill_logs` ${Companion.KILL_COLUMN}"
        const val CREATE_KILLED_LOGS = "CREATE TABLE IF NOT EXISTS `killed_logs` ${Companion.KILL_COLUMN}"
    }
}
